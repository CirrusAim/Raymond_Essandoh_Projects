...
type ParticipantServiceClient interface {
	...
	MarkReady(ctx context.Context, in *RegisterResponse, opts ...grpc.CallOption) (*empty.Empty, error)
	// GetResults RPC is called by the participants to get the results of
	// the participants
	GetResults(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *participantServiceClient) MarkReady(ctx context.Context, in *RegisterResponse, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *participantServiceClient) GetResults(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type ParticipantServiceServer interface {
	...
	// MarkReady RPC is called by the participants to tell the quizmaster
	// that it is ready to received the questions
	MarkReady(context.Context, *RegisterResponse) (*empty.Empty, error)
	// GetResults RPC is called by the participants to get the results of
	// the participants
	GetResults(context.Context, *empty.Empty) (*Result, error)
...
func (UnimplementedParticipantServiceServer) MarkReady(context.Context, *RegisterResponse) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MarkReady not implemented")
}
func (UnimplementedParticipantServiceServer) GetResults(context.Context, *empty.Empty) (*Result, error) {
...
func _ParticipantService_GetResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParticipantServiceServer).GetResults(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
